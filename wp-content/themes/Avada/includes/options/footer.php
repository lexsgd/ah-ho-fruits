		...
		'footer_content_options_subsection'          => [
			...
			'fields' => [
				...
				'footer_text'                            => [
					...
					'default'           => sprintf( esc_html__( 'Copyright %1$s | %2$s by %3$s | All Rights Reserved | Powered by %4$s', 'Avada' ), '2012 - ' . date( 'Y' ), '<a href="https://bit.ly/2YJkGCr">Avada Website Builder</a>', '<a href="https://avada.com/">Avada</a>', '<a href="https://wordpress.org">WordPress</a>' ),
					'type'              => 'code',
					'choices'           => [
						'language' => 'html',
						'height'   => 300,
