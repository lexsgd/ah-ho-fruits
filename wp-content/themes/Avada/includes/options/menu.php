...
function avada_options_section_menu( $sections ) {
	...
	$fields = [
		'heading_menu'               => [
			...
			'fields'   => [
				...
				'menu_highlight_style'               => [
					...
					'description'     => __( 'Controls the highlight style for main menu links and also affects the look of menu dropdowns. Arrow style cannot work with a transparent header background. Bar highlights will display vertically on side header layouts. <strong>IMPORTANT:</strong> Arrow & Background style can require configuration of other options depending on desired effect.', 'Avada' ) . ' <a href="https://avada.com/documentation/main-menu-highlight-styles/" target="_blank" rel="noopener noreferrer">' . esc_html__( 'See this post for more information', 'Avada' ) . '</a>.',
				...
				'main_menu_sub_menu_animation'       => [
					'label'       => esc_html__( 'Main Menu Dropdown / Legacy Mega Menu Animation', 'Avada' ),
				...
				'dropdown_menu_top_border_size'      => [
					...
					'description' => esc_html__( 'Controls top border size of dropdown menus and legacy mega menus.', 'Avada' ),
				...
				'main_nav_highlight_radius'          => [
					...
					'css_vars'    => [
						[
							...
							'element' => '.fusion-menu-highlight-label, .awb-menu__highlight',
						],
					],
				],
				'menu_sub_bg_color'                  => [
		...
		'mega_menu_subsection'       => [
			'label'  => esc_html__( 'Legacy Mega Menu', 'Avada' ),
			'id'     => 'mega_menu_subsection',
			'type'   => 'sub-section',
			'fields' => [
				'header_v6_used_note'             => ( '0' === Avada()->settings->get( 'dependencies_status' ) ) ? [] : [
					'label'       => '',
					'description' => '<div class="fusion-redux-important-notice">' . __( '<strong>IMPORTANT NOTE:</strong> Legacy Mega Menu Options are only available when using Header Layouts #1-5. Your current Header Layout #6 does not utilize the mega menu.', 'Avada' ) . '</div>',
				...
				'megamenu_disabled_note'          => ( '0' === Avada()->settings->get( 'dependencies_status' ) ) ? [] : [
					'label'       => '',
					'description' => '<div class="fusion-redux-important-notice">' . __( '<strong>IMPORTANT NOTE:</strong> Legacy Mega Menu is disabled in Advanced > Theme Features section. Please enable it to see the options.', 'Avada' ) . '</div>',
				...
				'megamenu_width'                  => [
					'label'           => esc_html__( 'Legacy Mega Menu Wrapper Max Width', 'Avada' ),
					'description'     => esc_html__( 'Controls the max width of the legacy mega menu. On boxed side header layouts, "Viewport Width" will match "Site Width".', 'Avada' ),
					'id'              => 'megamenu_width',
					'type'            => 'radio-buttonset',
					'default'         => 'site_width',
					'choices'         => [
				...
				'megamenu_max_width'              => [
					'label'           => esc_html__( 'Legacy Mega Menu Max-Width', 'Avada' ),
					'description'     => esc_html__( 'Controls the max width of the legacy mega menu.', 'Avada' ),
				...
				'megamenu_interior_content_width' => [
					'label'           => esc_html__( 'Legacy Mega Menu Interior Content Width', 'Avada' ),
				...
				'megamenu_title_size'             => [
					'label'       => esc_html__( 'Legacy Mega Menu Column Title Size', 'Avada' ),
				...
				'megamenu_item_vertical_padding'  => [
					'label'       => esc_html__( 'Legacy Mega Menu Dropdown Item Padding', 'Avada' ),
				...
				'megamenu_item_display_divider'   => [
					'label'       => esc_html__( 'Legacy Mega Menu Item Divider', 'Avada' ),
