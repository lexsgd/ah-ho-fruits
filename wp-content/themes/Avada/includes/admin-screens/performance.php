...
<?php $this->get_admin_screens_header( 'performance' ); ?>
	...
	<section class="avada-db-card avada-db-welcome-setup awb-wizard-section" data-step="1">
		...
		<div class="avada-db-setup">
			...
			<a href="https://avada.com/documentation/" target="_blank" rel="noopener" class="avada-db-setup-step avada-db-step-three avada-db-completed">
				<div class="avada-db-setup-step-info">
	...
	<section class="avada-db-card hidden awb-wizard-section" data-step="3">
		...
		<div class="avada-db-card-notice awb-wizard-tip">
			...
			<p class="avada-db-card-notice-heading"><strong><?php esc_html_e( 'Tip', 'Avada' ); ?></strong>: <?php esc_html_e( 'Convert from Font Awesome to a single custom icon set to improve your load time.', 'Avada' ); ?><a href="https://avada.com/documentation/how-to-replace-font-awesome-icons-with-a-custom-icon-set/" target="_blank" rel="noopener noreferrer"> <?php esc_html_e( 'Find Out How!', 'Avada' ); ?></a></p>
		</div>
	...
	<section class="avada-db-card hidden awb-wizard-section" data-step="4">
		...
		echo '<p class="wizard-recommendation"><i class="fusiona-af-rating"></i> ' . esc_html__( 'Recommend setting to none unless your largest contentful paint is text or an icon.', 'Avada' ) . '  <a href="https://www.youtube.com/watch?v=j1SA6D_PLWA" target="_blank" rel="noopener noreferrer">' . esc_html__( 'Find out how to optimize the largest contentful paint (LCP).', 'Avada' ) . '</a></p>';
	...
	<section class="avada-db-card hidden awb-wizard-section" data-step="5">
		...
		<div class="avada-db-card-notice awb-wizard-tip">
			<i class="fusiona-info-circle"></i>
			<p class="avada-db-card-notice-heading"><strong><?php esc_html_e( 'Tip', 'Avada' ); ?></strong>: <?php esc_html_e( 'Avoid using complex dynamic elements above the fold. ', 'Avada' ); ?><a href="https://avada.com/documentation/avada-optimization-guide/" target="_blank" rel="noopener noreferrer"> <?php esc_html_e( 'Find out more optimization tips in our documentation.', 'Avada' ); ?></a></p>
		</div>
	...
	<section class="avada-db-card hidden awb-wizard-section" data-step="6">
		...
		<?php
		echo $metaboxes->radio_buttonset( $options['upload_image_format']['id'], $options['upload_image_format']['label'], $options['upload_image_format']['choices'], $options['upload_image_format']['description'], $options['upload_image_format']['default'], [], 'default' );  // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		?>
	...
	<section class="avada-db-card hidden awb-wizard-section" data-step="7" data-id="finish">
		...
		<div class="awb-extra-reading">
			<a href="https://avada.com/documentation/what-are-google-core-web-vitals-and-why-they-matter/" target="_blank" rel="noopener noreferrer"><i class="fusiona-external-link"></i><?php esc_html_e( 'What are Google core web vitals', 'Avada' ); ?></a>
			<a href="https://www.youtube.com/watch?v=j1SA6D_PLWA" target="_blank" rel="noopener noreferrer"><i class="fusiona-external-link"></i><?php esc_html_e( 'How to optimize above the fold content for performance', 'Avada' ); ?></a>
			<a href="https://avada.com/documentation/image-format-and-size-guide/" target="_blank" rel="noopener noreferrer"><i class="fusiona-external-link"></i><?php esc_html_e( 'How to optimize the images on your website', 'Avada' ); ?></a>
		</div>
	</section>
