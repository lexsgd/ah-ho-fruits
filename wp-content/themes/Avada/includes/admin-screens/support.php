	...
	<section class="avada-db-card avada-db-card-first avada-db-support-start">
		...
		<div class="avada-db-card-notice">
			...
			<p class="avada-db-card-notice-heading">
				<a href="https://my.avada.com/licenses/" target="_blank"><?php esc_html_e( 'Create your support account.', 'Avada' ); ?></a>
			</p>
		</div>
	</section>
	...
	<section class="avada-db-card avada-db-support-channels">
		...
		<div class="avada-db-card-grid">
			<div class="avada-db-card-notice">
				...
				<p class="avada-db-card-notice-content">
					<a href="https://avada.com/documentation/avada-quick-start-guide/" class="button button-primary" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Starter Guide', 'Avada' ); ?></a>
				</p>
			</div>
			...
			<div class="avada-db-card-notice">
				...
				<p class="avada-db-card-notice-content">
					<a href="https://avada.com/help-center/" class="button button-primary" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Documentation', 'Avada' ); ?></a>
				</p>
			</div>
			...
			<div class="avada-db-card-notice">
				...
				<p class="avada-db-card-notice-content">
					<a href="https://my.avada.com/submit-a-ticket/" class="button button-primary" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Submit A Ticket', 'Avada' ); ?></a>
				</p>
			</div>
		</div>
		...
		<div class="avada-db-card-grid">
			<div class="avada-db-card-notice">
				...
				<p class="avada-db-card-notice-content">
					<a href="https://www.youtube.com/@AvadaVideos" class="button button-primary" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Watch Videos', 'Avada' ); ?></a>
				</p>
			</div>
			...
			<div class="avada-db-card-notice">
				<div class="avada-db-card-notice-heading">
					...
					<h3><?php esc_html_e( 'Engage With Us', 'Avada' ); ?></h3>
				</div>
				<p class="avada-db-card-notice-content">
					<?php esc_html_e( 'Have your say on the future of Avada by voting on new features, prebuilt websites and studio content.  You can also request the new additions that appeal to you the most.', 'Avada' ); ?>
				</p>
				<p class="avada-db-card-notice-content">
					<a href="https://my.avada.com/feature-voting/" class="button button-large button-primary" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Community Forum', 'Avada' ); ?></a>
				</p>
			</div>
