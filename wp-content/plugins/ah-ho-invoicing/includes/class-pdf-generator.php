...
class AH_HO_PDF_Generator {
    ...
    // Dompdf hashed font base name (generated by FontMetrics::registerFont)
    // This is deterministic based on font family + style + font file content
    const CJK_FONT_BASE = 'noto_sans_sc_normal_d4251901d7080d141f2a9b2da90ce3a3';
    ...
    private static function install_cjk_font() {
        ...
        $source_ttf = $assets_dir . 'NotoSansSC-Regular.ttf';
